...
def print_section(df, title, subtitle, data_start, data_end):
    """Print a report section for a subset of customers."""
    if len(df) == 0:
        return
    ...
    print("\n\n" + "="*72)
    print(f"TOTAL: {len(df)} customers, {format_currency(df['lifetime_revenue'].sum())}")
    print("="*72 + "\n")


def main(input_file: str, filter_type: str):
    ...
    # Filter and print based on filter_type
...
if __name__ == "__main__":
    ...
    main(args.input_file, filter_type)
